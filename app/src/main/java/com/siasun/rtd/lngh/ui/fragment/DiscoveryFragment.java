 ...
 * 惠商城fragment
 */
public final class DiscoveryFragment extends MyFragment<MainTabActivity> implements StatusAction, OnRefreshListener{
    ...
    protected void initData() {
        ...
        String url = "http://182.92.172.248/lgh/views/discovery/discovery.html";
        //String url = "http://app.lnszgh.org/lgh/views/discovery/discovery.html";
